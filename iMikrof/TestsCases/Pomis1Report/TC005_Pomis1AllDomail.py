...
class TC001_Pomis1_Report(BaseCase):
    def test_Operation_1(self):
        ...
        self.wait(2)
        self.type(report_level, "Domain")
        self.wait(2)
        self.type(branch, "2 - Operation-1")
    ...
    def test_Operation_3(self):
        ...
        self.type(report_level, "Domain")
        self.wait(2)
        self.type(branch, "3 - Operation-3")
        self.type(month, set_month)
        self.type(year, set_year)
        #self.type(loan_option, set_loan_option)
        self.click(show)
    ...
    def test_Operation_4(self):
        ...
        self.type(report_level, "Domain")
        self.wait(2)
        self.type(branch, "4 - Operation-4")
        self.type(month, set_month)
        self.type(year, set_year)
        #self.type(loan_option, set_loan_option)
        self.click(show)
    ...
    def test_Operation_9(self):
        ...
        self.type(report_level, "Domain")
        self.wait(2)
        self.type(branch, "5 - Operation-9")
        self.type(month, set_month)
        self.type(year, set_year)
        #self.type(loan_option, set_loan_option)
        self.click(show)
    ...
    def test_Operation_11(self):
        ...
        self.type(report_level, "Domain")
        self.wait(2)
        self.type(branch, "6 - Operation-11")
        self.type(month, set_month)
        self.type(year, set_year)
        #self.type(loan_option, set_loan_option)
        self.click(show)
