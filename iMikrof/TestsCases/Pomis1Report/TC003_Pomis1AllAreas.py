...
class TC001_Pomis1_Report(BaseCase):
    ...
    def test_Sherpur_Area(self):

        print("********* Start Sherpur Area ********")
    ...
    def test_Hakimpur_Area(self):

        print("********* Start Hakimpur Area *********")
    ...
    def test_Akkelpur_Area(self):

        print("********* Start Akkelpur Area *********")
    ...
    def test_Nozipur_Area(self):

        print("********* Start Nozipur Area *********")
    ...
    def test_Nimgachi_Area(self):

        print("********* Start Nimgachi Area *********")
    ...
    def test_Ullapara_Area(self):

        print("********* Start Ullapara Area *********")
    ...
    def test_Puspopara_Area(self):

        print("********* Start Puspopara Area *********")
    ...
    def test_Puthia_Area(self):

        print("********* Start Puthia Area *********")
    ...
    def test_Rajshahi_Area(self):

        print("********* Start Rajshahi Area *********")
    ...
    def test_Fulbari_Area(self):

        print("********* Start Fulbari Area *********")
